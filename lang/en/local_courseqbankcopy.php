...
$string['diagnosticsbankorcategory'] = 'Question-bank entry or category';
...
$string['diagnosticsexternalfixedreferences'] = 'External fixed references';
$string['diagnosticsexternalrandomreferences'] = 'External random references';
$string['diagnosticsexternalreferences'] = 'External random references';
$string['diagnosticsfixedreferences'] = 'Fixed-question references';
$string['diagnosticsgenerate'] = 'Generate report';
$string['diagnosticsindependent'] = 'No external or invalid fixed-question or random-question references were found.';
$string['diagnosticsindependentfixedreferences'] = 'Independent fixed references';
$string['diagnosticsindependentrandomreferences'] = 'Independent random references';
$string['diagnosticsinternalquestionentries'] = 'Total internal question entries (main + subquestions)';
$string['diagnosticsinternalsubquestions'] = 'Internal subquestions (Cloze)';
$string['diagnosticsintro'] = 'This read-only report identifies question-bank, fixed-question and random-question references for a destination course. It does not change Moodle data.';
$string['diagnosticsinvalidfixedreferences'] = 'Invalid fixed references';
$string['diagnosticsinvalidrandomreferences'] = 'Invalid random references';
$string['diagnosticsitem'] = 'Item';
$string['diagnosticsjson'] = 'Complete technical report (JSON)';
$string['diagnosticsmainquestions'] = 'Main questions';
$string['diagnosticsmigrationtasks'] = 'Pending migration tasks';
$string['diagnosticsnoreferences'] = 'No fixed-question or random-question references were found in this course.';
...
$string['diagnosticsproblemsfound'] = '{$a->external} external reference(s) and {$a->invalid} invalid reference(s) were found among fixed and random questions.';
$string['diagnosticsquestionbankentry'] = 'Entry #{$a}';
...
$string['diagnosticsreferencestable'] = 'Fixed-question and random-question references';
...
$string['diagnosticsstatusinvalid'] = 'Invalid';
$string['diagnosticstitle'] = 'Question bank copy diagnostics';
$string['diagnosticstype'] = 'Type';
$string['diagnosticstypefixed'] = 'Fixed';
$string['diagnosticstyperandom'] = 'Random';
