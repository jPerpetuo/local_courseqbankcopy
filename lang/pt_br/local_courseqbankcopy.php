...
$string['diagnosticsindependent'] = 'Nenhuma referência externa de questão aleatória foi encontrada.';
...
$string['diagnosticsintro'] = 'Este relatório somente de leitura identifica os bancos de questões e as referências de questões aleatórias de um curso de destino. Ele não altera os dados do Moodle.';
...
$string['diagnosticsnoreferences'] = 'Nenhuma referência de questão aleatória foi encontrada neste curso.';
...
$string['diagnosticsreferencestable'] = 'Referências de questões aleatórias';
